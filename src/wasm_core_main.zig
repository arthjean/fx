...
pub fn main(init: std.process.Init) !void {
    ...
    try acp_server.run(std.heap.c_allocator, .{
        ...
        .gateway_system = js_host_gateway_system,
...
const js_host_gateway_system = gateway_system.System{
    .connection_seed = builtin_gateway.connection_seed,
    .adapter_registry = .{ .adapters = &js_host_adapters },
};

const js_host_route_adapter = agent_stream_provider.ProviderAdapter{
...
const js_host_adapters = [_]agent_stream_provider.ProviderAdapter{js_host_route_adapter};
