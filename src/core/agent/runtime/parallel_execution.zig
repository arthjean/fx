...
pub const ParallelHookExecContext = struct {
    ...
    turn_id: u64,
    route: ?*const @import("../../gateway/route_snapshot.zig").RouteSnapshot = null,
    provider_adapter: ?@import("../stream_provider.zig").ProviderAdapter = null,
...
pub fn parallelHookExecute(ctx: *anyopaque, alloc: Allocator, call: ToolCall, index: usize) !ToolExecutionResult {
    ...
    return exec_ctx.hooks.execute_tool_call(exec_ctx.hooks.ctx, .{
        ...
        .call = call,
        .authority = .ordinary,
        .route = exec_ctx.route,
        .provider_adapter = exec_ctx.provider_adapter,
        .route_credential = exec_ctx.route_credential,
        .route_tenant = exec_ctx.route_tenant,
